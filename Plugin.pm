...
#
#	Copyright (c) 2003-2020 by GWENDESIGN
#	All rights reserved.
#
#	----------------------------------------------------------------------
#	IR-Blaster
...
#	History:
#
#	2024/07/13 v6.2.3 - Max LMS version adjusted from 8.* to 9.* (no functional changes)
#	2020/05/09 v6.2.2 - Max LMS version adjusted from 7.* to 8.* (no functional changes)
